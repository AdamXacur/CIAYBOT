    ...
    <div className="min-h-screen bg-ciay-cream flex font-sans">
      ...
      <aside className="w-64 bg-ciay-brown text-white flex flex-col shadow-2xl z-20 border-r border-ciay-gold/20">
             ...
             return (
               <Link 
                 ...
                 className={`flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-all ${
                    isActive 
                    ? "bg-white/10 text-white border-l-4 border-ciay-gold shadow-inner" 
        ...
        <div className="p-4 border-t border-white/10 bg-black/20">
            <button onClick={logout} className="flex items-center gap-2 text-sm text-gray-300 hover:text-white w-full transition-colors">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="bg-white border-b border-ciay-brown/10 h-16 flex items-center justify-between px-8 shadow-sm">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="w-8 h-8 rounded-full bg-ciay-brown text-white flex items-center justify-center font-bold text-xs border-2 border-ciay-gold">
                    AD
                </div>
            </div>
        </header>
